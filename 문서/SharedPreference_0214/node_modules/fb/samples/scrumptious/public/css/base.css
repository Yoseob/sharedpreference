...
.ui-mobile .type-home .login-button {
    text-align: center;
}
...
span.tagline {
    font-size: 1.5em;
    font-family: Zapfino, Helvetica, Arial, san-serif;
    color: #99ccff;
...
.ui-mobile .type-menu .ui-content {
    margin: 0;
    text-align: center;
}

.type-menu .ui-content {
    margin-top: 5px;
    overflow: hidden;
    position: relative;
}

.ui-mobile .type-menu .ui-content .ui-listview li a img {
    width: 60px;
    height: 60px;
    margin-top: 10px;
    padding-right: 0px;
...
.ui-mobile .type-menu .ui-content .ui-listview li a p {
    font-size: 0.8em;
    color: #99ccff;
}

.ui-mobile .type-menu .ui-content .ui-listview li a h3 {
    margin-left: -20px;
}
...
.ui-mobile .type-menu .submit-button {
    margin-left: 20px;
    margin-right: 20px;
}

.ui-mobile .type-menu-drilldown .ui-content .ui-listview li a img {
    width: 57px;
    height: 57px;
    margin-top: 10px;
    padding-left: 10px;
